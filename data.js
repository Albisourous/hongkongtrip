...
const TRIP = {
  ...
  days: [
    ...
    {
      date: "Sep 28", day: "Mon", base: "HK → Guangzhou", stay: "Grand Hyatt Guangzhou TBD (all 6)", legs: ["gz", "sz"],
      ...
      checklist: [
        ...
        { t: "11:30am", task: "Metro → Grand Hyatt Guangzhou, drop bags / check in" },
  ...
  costs: [
    ...
    { id: "gz-hotel", leg: "gz", cat: "Hotel", label: "Grand Hyatt Guangzhou — Sep 28 (1 night)", total: null, perPerson: null, frontedBy: null, status: "to-book", sleeps: null, note: "All 6 mainland: KJ · Kevin Li · Shruthik · Wesley · Albin · Maas — ~3 rooms · Zhujiang New Town, by Canton Tower / Huacheng Sq · book on Albin's Hyatt account", url: "https://www.hyatt.com/grand-hyatt/en-US/cangh-grand-hyatt-guangzhou", linkLabel: "Hyatt — Grand Hyatt Guangzhou" },
