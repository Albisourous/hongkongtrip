...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      notes: "Baiyun Mountain in the morning — cableway runs ~9:00–18:00 from Yuntai Garden (south gate), Didi ~30 min each way. Liwan loop compressed to Shamian + Yongqingfang; Chen Clan Academy, Guangxiao Temple and Liwan Lake become optional. Bags stay at the Grand Hyatt; Canton Tower is right by the hotel. Night HSR to Shenzhen — book it with the Sep 28 tickets.",
      checklist: [
        ...
        { t: "3:30pm", task: "Yongqingfang lanes + Bruce Lee ancestral home (~15-min walk)" },
        { t: "4:45pm", task: "(opt) Chen Clan Academy folk art · Liwan Lake Park tai chi + cards — if time allows" },
