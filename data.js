...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      notes: "All Kowloon stops before lunch are ~10 min apart; cross the harbour once for the Peak, then ride the Star Ferry back into LKF. Symphony of Lights 8pm is optional — watch from TST harbourfront or mid-harbour on the ferry.",
      checklist: [
        ...
        { t: "8:00pm", task: "(opt) Symphony of Lights, TST harbourfront" },
        { t: "8:30pm", task: "Star Ferry TST → Central" },
    ...
    },
    {
      ...
      notes: "HSR opens 15 days out — passport ticket. Carry the Shekou→Macau ferry ticket — it doubles as onward-ticket proof for the 240-hr transit.",
      checklist: [
        { t: "9:00am", task: "Check out · MTR → West Kowloon HSR terminus" },
        { t: "10:00am", task: "HSR West Kowloon → Guangzhou South (~1h, all 6)" },
        { t: "11:30am", task: "Metro → Grand Hyatt, drop bags (check-in 3pm)" },
        { t: "12:30pm", task: "Beijing Rd pedestrian st — ancient road under glass floor + lunch" },
        { t: "6:00pm", task: "Dinner around Beijing Rd" },
        { t: "8:00pm", task: "Pearl River night cruise from Tianzi Pier (~10-min walk) — sails past Canton Tower" },
      ],
    },
    {
    ...
    },
    {
      ...
      checklist: [
        ...
        { t: "2:00pm", task: "DJI flagship @ OCT Harbour — fly drones + RoboMaster (free)" },
        { t: "4:00pm", task: "Talent Park next door — Meituan drone coffee (~¥25) + Pony.ai robotaxi (~¥10)" },
        { t: "5:30pm", task: "Shenzhen Bay boardwalk — connects to Talent Park (~10.6km flat)" },
        { t: "8:00pm", task: "COCO Park, Futian — on the metro line back toward Dongmen" },
        { t: "late", task: "Dongmen pedestrian st — right at the hotel (veg stalls + HeyTea, born in this region)" },
      ],
    },
    {
  ...
  costs: [
    ...
    { id: "gz-hotel", leg: "gz", cat: "Hotel", label: "Grand Hyatt Guangzhou — 2× Twin (Zhujiang New Town)", total: 284, perPerson: null, frontedBy: "albin", status: "booked", sleeps: 6, note: "Hyatt confs 40023B27689039 + 40023B27689093 · Award Cat 2, special rate 54749 (same award code as SZ — ~16,000 pts expected) · 45sqm twin, 2 singles, 3 adults/room → 6 beds for all 6 · ~$284 pts value · Sep 28–29, in 3pm / out 12pm · 12 Zhujiang West Rd, by Canton Tower / Huacheng Sq · on Albin's Hyatt account", url: "https://www.hyatt.com/grand-hyatt/en-US/guagh-grand-hyatt-guangzhou", linkLabel: "Hyatt — Grand Hyatt Guangzhou" },
    { id: "sz-hotel", leg: "sz", cat: "Hotel", label: "Hyatt Place Shenzhen Dongmen — Sep 30 night, 3× Specialty Twin (Laojie MTR, Luohu)", total: 250, perPerson: null, frontedBy: "albin", status: "booked", sleeps: 6, note: "Hyatt confs 56229190 + 14228517 + 45139912 · 13,500 pts total (4,500/room — ~$250 pts value) · Sep 30–Oct 1, in 3pm / out 12pm · Laojie MTR exit H, turn left · breakfast incl up to 2/room · Sep 29 night = separate booking (sz-hotel-2)", url: "https://www.hyatt.com/hyatt-place/en-US/szxzs-hyatt-place-shenzhen-dongmen", linkLabel: "Hyatt — Hyatt Place Dongmen" },
    { id: "sz-hotel-2", leg: "sz", cat: "Hotel", label: "Hyatt Place Shenzhen Dongmen — Sep 29 night, 3× Specialty Twin (Laojie MTR, Luohu)", total: 250, perPerson: null, frontedBy: "albin", status: "booked", sleeps: 6, note: "Hyatt confs 37134482 + 29032314 + 31333538 · 13,500 pts total (4,500/room — ~$250 pts value) · Sep 29–30, in 3pm / out 12pm · Laojie MTR exit H, turn left · breakfast incl up to 2/room", url: "https://www.hyatt.com/hyatt-place/en-US/szxzs-hyatt-place-shenzhen-dongmen", linkLabel: "Hyatt — Hyatt Place Dongmen" },
