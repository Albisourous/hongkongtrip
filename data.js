...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      checklist: [
        ...
        { t: "12:15pm", task: "Taxi/shuttle → Tung Chung · Ngong Ping 360 cable car up (~25 min)" },
  ...
  places: [
    ...
    { name: "Ngong Ping 360 — Tung Chung terminal", leg: "hk2", cat: "move", day: "Oct 2", lat: 22.2894, lng: 113.9407, note: "~25-min cable car to the Buddha" },
