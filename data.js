...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      checklist: [
        { t: "10:00am", task: "Check out · MTR → West Kowloon HSR terminus" },
        { t: "12:00pm", task: "HSR West Kowloon → Guangzhou South (~1h, all 6)" },
        { t: "1:30pm", task: "Metro → GZ hotel, check in" },
        { t: "3:00pm", task: "Beijing Rd pedestrian st — ancient road under glass floor" },
    ...
    },
    {
      ...
      notes: "Liwan walking day — dim sum, Shamian, Chen Clan, Yongqingfang and Liwan Lake all sit within ~2 km. Canton Tower is the only cross-river hop.",
      checklist: [
        ...
        { t: "6:30pm", task: "Canton Tower across the river (~30 min metro) — sunset/night view" },
        { t: "8:30pm", task: "Beijing Rd late snacks + herbal tea 凉茶" },
      ],
    },
    {
      ...
      checklist: [
        ...
        { t: "12:30pm", task: "Bag drop + lunch at Hyatt Place Dongmen (check-in 3pm) — on Dongmen pedestrian st" },
        { t: "2:00pm", task: "Metro west to Nanshan — DJI flagship @ OCT Harbour: fly drones + RoboMaster (free)" },
