...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      checklist: [
        { t: "9:00am", task: "Margaret's Café e Nata egg tarts + last Senado loop" },
        { t: "9:00am", task: "(opt) Lord Stow's Bakery, Coloane village — THE original Portuguese egg tart (~25-min bus each way; skip if the ferry timing is tight)" },
