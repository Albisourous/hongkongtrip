...
const TRIP = {
  ...
  days: [
    ...
    },
    {
      ...
      checklist: [
        ...
        { t: "11:15am", task: "(opt) Macau Tower — Skywalk rim walk (~MOP 800) or bungy, world's highest at 233m (~MOP 3,600+) — ~10 min taxi south" },
        ...
        { t: "7:30pm", task: "Cotai strip: Venetian · Londoner · Studio City · Galaxy — Lord Stow's egg tarts have a branch inside the Venetian" },
        { t: "9:00pm", task: "(opt) Lisboeta Cotai, ~5 min away — GoAirborne indoor skydiving + ZIPCITY 388m urban zipline (night rides w/ light show) + Macau's first indoor karting" },
  ...
  places: [
    ...
    { name: "Alps Ice World — Window of the World", leg: "sz", cat: "see", day: "Sep 30 (opt)", lat: 22.5348, lng: 113.9765, note: "indoor ski/snowboard · ~¥90–110/2h incl gear" },
    { name: "K1 Speed — Shekou Sea World", leg: "sz", cat: "see", day: "Sep 30 (opt)", lat: 22.4845, lng: 113.9160, note: "indoor electric karting · til ~10pm" },
