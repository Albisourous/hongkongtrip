...
(function () {
  ...
  section.appendChild(el("h2", null, "Day-by-day"));
  section.appendChild(el("p", "muted day-hint",
    "Tap a day above, or swipe the card sideways."));
  ...
  function show(i, scrollChip) {
    ...
    detail.appendChild(el("p", "muted", "Stay: " + day.stay));
